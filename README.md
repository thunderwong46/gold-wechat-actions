...
- 驱动因素评分：后台纳入金价、美元、美债、实际利率、GLD、白银、VIX、标普500、新闻、财经日历等数据；微信正文只展示最关键的5条。
...
- 报告还会尝试读取美元指数、美国10年期收益率、实际利率、GLD、白银、VIX、标普500和近24小时新闻。
- 后台参考数据会完整保存到 `data/YYYY/YYYY-MM-DD.json`，用于周报复盘和以后优化模型；微信正文保持简短。
